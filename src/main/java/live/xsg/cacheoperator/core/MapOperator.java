...
public interface MapOperator {
     ...
     * @return 返回缓存中的数据
     */
    Map<String, String> getAllMapAsync(String key, long expire, Refresher<Map<String, String>> flusher);
     ...
     * @return 返回缓存中的数据
     */
    Map<String, String> getAllMapAsync(String key, long expire, Refresher<Map<String, String>> flusher, ExecutorService executorService);
}
